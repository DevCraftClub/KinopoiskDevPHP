...
enum SortField: string {
	...
	public function getDescription(): string {
		...
		$result = match ($this) {
			...
			self::DEATH                       => 'Дата смерти',
			self::PROFESSION                  => 'Профессия',
			self::SPOUSES_ID                  => 'ID супруга/супруги',
			self::SPOUSES_NAME                => 'Имя супруга/супруги',
			self::SPOUSES_DIVORCED            => 'Разведены?',
			self::SPOUSES_DIVORCED_REASON     => 'Причина развода',
			self::SPOUSES_SEX                 => 'Пол супруги/супруга',
			self::SPOUSES_CHILDREN            => 'Общие дети',
			self::SPOUSES_RELATION            => 'Отношение',
			self::FACTS                       => 'Факты',
			self::MOVIES_ID                   => 'ID фильма/сериала',
			self::MOVIES_NAME                 => 'Название фильма',
			self::MOVIES_ALTERNATIVE_NAME     => 'Альтернативное название',
			self::MOVIES_RATING               => 'Рейтинг фильма',
			self::MOVIES_GENERAL              => 'Общая информация',
			self::MOVIES_DESCRIPTION          => 'Описание фильма',
			self::MOVIES_EN_PROFESSION        => 'Роль в фильме',
			self::BIRTH_PLACE                 => 'Место рождения',
			self::DEATH_PLACE                 => 'Место смерти',
			self::COUNT_AWARDS                => 'Количество наград',
			self::AGE                         => 'Возраст',
		};
