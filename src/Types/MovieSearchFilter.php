...
class MovieSearchFilter extends MovieFilter {
    ...
    /**
     * Добавляет фильтр для поиска по названию с использованием регулярного выражения
     * 
    ...
    /**
     * Добавляет фильтр для поиска по английскому названию с использованием регулярного выражения
     * 
     * @param string $query Поисковый запрос
     * @return $this
     */
    ...
    /**
     * Добавляет фильтр для поиска по описанию с использованием регулярного выражения
     * 
     * @param string $query Поисковый запрос
     * @return $this
     */
    ...
    /**
     * Добавляет фильтр для поиска фильмов с рейтингом выше указанного
     * 
    ...
    /**
     * Добавляет фильтр для поиска фильмов с рейтингом ниже указанного
     * 
    ...
    /**
     * Добавляет фильтр для поиска фильмов в диапазоне рейтинга
     * 
     * @param float $minRating Минимальный рейтинг
     * @param float $maxRating Максимальный рейтинг
     * @param string $field Поле рейтинга (kp, imdb, tmdb, filmCritics, russianFilmCritics, await)
    ...
    public function withRatingBetween(float $minRating, float $maxRating, string $field = 'kp'): self {
        // Используем новый метод ratingRange вместо двух отдельных фильтров
        $this->ratingRange($minRating, $maxRating, $field);
        return $this;
    }
