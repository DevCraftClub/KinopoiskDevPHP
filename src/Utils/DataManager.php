...
abstract class DataManager {
	 ...
	 *
	 * @param   array   $data     Массив данных API, содержащий различные поля фильма или других объектов
	 ...
	 *
	 * @return  array   Массив объектов указанного типа или значение по умолчанию, если ключ не найден.
