...
class StudioTypeTest extends TestCase {
	...
	public function test_getDescription_returns_correct_descriptions(): void {
		...
		$this->assertEquals('Студия, специализирующаяся на создании визуальных и компьютерных эффектов',
			StudioType::SPECIAL_EFFECTS->getDescription());
		$this->assertEquals('Дистрибьюторская компания, занимающаяся прокатом и распространением фильмов',
			StudioType::DISTRIBUTION->getDescription());
